...
export const createLayouts = (userConfig: PartialDeep<LayoutConfig>): Plugin => {
  return (): void => {
    ...
    layoutConfig.app.logo_black = userConfig.app?.logo_black ?? layoutConfig.app.logo_black as any
    ...
    layoutConfig.app.iconRenderer = userConfig.app?.iconRenderer ?? layoutConfig.app.iconRenderer as any
