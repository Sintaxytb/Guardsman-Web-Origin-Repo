...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@axios': fileURLToPath(new URL('./resources/ts/utils/api.ts', import.meta.url)),
      '@validators': fileURLToPath(new URL('./resources/ts/@core/utils/validators.ts', import.meta.url))
    },
  },
  build: {
